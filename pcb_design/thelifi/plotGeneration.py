...
def calculate_freq_shifts(plot_config):
    """Calculate frequency shifts ensuring 0 is always included"""
...
def generate_s11_return_loss_plot(networks, plot_config, kpi_config, sim_data, freq_shifts, save_folder):
    """Generate S11 Return Loss Plot"""
    ...
    for filename, network in networks.items():
        for shift in freq_shifts:
            ...
            plt.plot(freq_mhz, s11_db, alpha=0.7, label=label)
    ...
    plot_path = os.path.join(save_folder, 'S11_Return_Loss.png')
    plt.savefig(plot_path, dpi=300, bbox_inches='tight')
    plt.close()
    
    return 'S11_Return_Loss.png'


def generate_s22_return_loss_plot(networks, plot_config, kpi_config, sim_data, freq_shifts, save_folder):
    """Generate S22 Return Loss Plot"""
    plt.figure(figsize=(12, 8))
    ...
    for filename, network in networks.items():
        for shift in freq_shifts:
            ...
            plt.plot(freq_mhz, s22_db, alpha=0.7, label=label)
    ...
    plot_path = os.path.join(save_folder, 'S22_Return_Loss.png')
    plt.savefig(plot_path, dpi=300, bbox_inches='tight')
    plt.close()
    
    return 'S22_Return_Loss.png'


def generate_s21_insertion_loss_plot(networks, plot_config, kpi_config, sim_data, freq_shifts, save_folder):
    """Generate S21 Insertion Loss Plot (Pass-band)"""
    plt.figure(figsize=(12, 8))
    ...
    for filename, network in networks.items():
        for shift in freq_shifts:
            ...
            plt.plot(freq_mhz, s21_db, alpha=0.7, label=label)
    ...
    # Configure plot for insertion loss (pass-band view)
    ...
    plot_path = os.path.join(save_folder, 'S21_Insertion_Loss.png')
    plt.savefig(plot_path, dpi=300, bbox_inches='tight')
    plt.close()
    
    return 'S21_Insertion_Loss.png'


def generate_s21_rejection_loss_plot(networks, plot_config, kpi_config, sim_data, freq_shifts, save_folder):
    """Generate S21 Rejection Loss Plot (Stop-band/Full range)"""
    plt.figure(figsize=(12, 8))
    ...
    # Configure plot for rejection loss (stop-band/full range view)
    ...
    plot_path = os.path.join(save_folder, 'S21_Rejection_Loss.png')
    plt.savefig(plot_path, dpi=300, bbox_inches='tight')
    plt.close()
    
    return 'S21_Rejection_Loss.png'
...
def generate_group_delay_plot(networks, plot_config, kpi_config, sim_data, freq_shifts, save_folder):
    ...
    for fname, nt in networks.items():
        for s in freq_shifts:
            ...
            plt.plot(nt_shift.frequency.f/1e6, gd_ns, alpha=.7,
                    label = fname + ("" if s==0 else " {:+.1f} MHz".format(s)))
    ...
    plot_path = os.path.join(save_folder, "GD_Curve.png")
...
def generate_linear_phase_deviation_plot(networks, plot_config, kpi_config, sim_data, freq_shifts, save_folder):
    """Generate Linear Phase Deviation Plot"""
    def phase_and_gd(network):
        f_hz = network.frequency.f
        ang = np.unwrap(np.angle(network.s[:,1,0]))
        df = np.gradient(f_hz)
    ...
    # Add sigma curves for Linear Phase Deviation measurements if enabled
    if plot_config['sigma_settings']['enabled'] and plot_config['sigma_settings']['sigma_values']:
...
def generate_gdv_scatter_plot(networks, plot_config, kpi_config, save_folder):
    """Generate GD Variation Scatter Plot"""
    def phase_and_gd(network):
        f_hz = network.frequency.f
        ang = np.unwrap(np.angle(network.s[:,1,0]))
        df = np.gradient(f_hz)
...
def generate_individual_box_plot(param_name, param_data, save_folder):
    """Generate individual box plot for a parameter"""
...
def generate_individual_histogram_plot(param_name, param_data, save_folder):
    """Generate individual histogram plot for a parameter"""
    plt.figure(figsize=(10, 6))
...
def create_s_parameter_plots(networks, plot_config, kpi_config, sim_data=None, save_folder='.'):
    ...
    plots_created.append(generate_s11_return_loss_plot(networks, plot_config, kpi_config, sim_data, freq_shifts, save_folder))
    plots_created.append(generate_s22_return_loss_plot(networks, plot_config, kpi_config, sim_data, freq_shifts, save_folder))
    plots_created.append(generate_s21_insertion_loss_plot(networks, plot_config, kpi_config, sim_data, freq_shifts, save_folder))
    plots_created.append(generate_s21_rejection_loss_plot(networks, plot_config, kpi_config, sim_data, freq_shifts, save_folder))
...
def create_advanced_plots(plot_config, kpi_config, networks, freq_shifts, save_folder='.'):
    ...
    plots_created.append(generate_group_delay_plot(networks, plot_config, kpi_config, {}, freq_shifts, save_folder))
    plots_created.append(generate_linear_phase_deviation_plot(networks, plot_config, kpi_config, {}, freq_shifts, save_folder))
    plots_created.append(generate_flatness_scatter_plot(networks, plot_config, kpi_config, save_folder))
    plots_created.append(generate_gdv_scatter_plot(networks, plot_config, kpi_config, save_folder))
...
def generate_all_plots(plot_config_data, excel_files, s2p_files, sim_s2p_files=None, s11_sigma_files=None, s21_sigma_files=None, kpi_config_data=None, save_folder='.'):
    ...
    try:
        ...
        all_plots.append(generate_s11_return_loss_plot(networks, plot_config, kpi_config, sim_data, freq_shifts, save_folder))
        all_plots.append(generate_s22_return_loss_plot(networks, plot_config, kpi_config, sim_data, freq_shifts, save_folder))
        all_plots.append(generate_s21_insertion_loss_plot(networks, plot_config, kpi_config, sim_data, freq_shifts, save_folder))
        all_plots.append(generate_s21_rejection_loss_plot(networks, plot_config, kpi_config, sim_data, freq_shifts, save_folder))
        
        # Advanced Plots (4 plots)
        all_plots.append(generate_group_delay_plot(networks, plot_config, kpi_config, sim_data, freq_shifts, save_folder))
        all_plots.append(generate_linear_phase_deviation_plot(networks, plot_config, kpi_config, sim_data, freq_shifts, save_folder))
        all_plots.append(generate_flatness_scatter_plot(networks, plot_config, kpi_config, save_folder))
        all_plots.append(generate_gdv_scatter_plot(networks, plot_config, kpi_config, save_folder))
...
def generate_single_s11_plot(plot_config_data, s2p_files, sim_s2p_files=None, s11_sigma_files=None, kpi_config_data=None, save_folder='.'):
    ...
    try:
        ...
        return [generate_s11_return_loss_plot(networks, plot_config, kpi_config, sim_data, freq_shifts, save_folder)]
...
def generate_single_s22_plot(plot_config_data, s2p_files, sim_s2p_files=None, kpi_config_data=None, save_folder='.'):
    ...
    try:
        ...
        return [generate_s22_return_loss_plot(networks, plot_config, kpi_config, sim_data, freq_shifts, save_folder)]
...
def generate_single_s21_il_plot(plot_config_data, s2p_files, sim_s2p_files=None, s21_sigma_files=None, kpi_config_data=None, save_folder='.'):
    ...
    try:
        ...
        return [generate_s21_insertion_loss_plot(networks, plot_config, kpi_config, sim_data, freq_shifts, save_folder)]
...
def generate_single_s21_rej_plot(plot_config_data, s2p_files, sim_s2p_files=None, s21_sigma_files=None, kpi_config_data=None, save_folder='.'):
    ...
    try:
        ...
        return [generate_s21_rejection_loss_plot(networks, plot_config, kpi_config, sim_data, freq_shifts, save_folder)]
...
def generate_single_gd_plot(plot_config_data, s2p_files, kpi_config_data=None, save_folder='.'):
    ...
    try:
        ...
        return [generate_group_delay_plot(networks, plot_config, kpi_config, {}, freq_shifts, save_folder)]
...
def generate_single_lpd_plot(plot_config_data, s2p_files, kpi_config_data=None, save_folder='.'):
    ...
    try:
        ...
        return [generate_linear_phase_deviation_plot(networks, plot_config, kpi_config, {}, freq_shifts, save_folder)]
...
def generate_single_flatness_plot(plot_config_data, s2p_files, kpi_config_data=None, save_folder='.'):
    ...
    try:
        ...
        return [generate_flatness_scatter_plot(networks, plot_config, kpi_config, save_folder)]
...
def generate_single_gdv_plot(plot_config_data, s2p_files, kpi_config_data=None, save_folder='.'):
    ...
    try:
        ...
        return [generate_gdv_scatter_plot(networks, plot_config, kpi_config, save_folder)]
...
def generate_selected_s_parameter_plots(
    plot_config_data, excel_files, s2p_files, sim_s2p_files=None,
    s11_sigma_files=None, s21_sigma_files=None, kpi_config_data=None, save_folder='.'
):
    """
    ...
    try:
        ...
        requested = set([p.lower() for p in plot_config.get("parameters_for_statistical_plots", [])])
