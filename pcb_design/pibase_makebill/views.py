...
class MakeBillGetAPIView(APIView):
    ...
    def get(self, request, pk):
        try:
            make_bill_logs.info(f"Getting MakeBillRecord API called for: {pk} -- user: {request.user}")
...
class MakeBillGetAPIView(APIView):
    ...
    COMPONENT_FIELDS = [
        "pcb_details", "can_details", "chip_capacitor_details", "chip_inductor_details",
        "chip_aircoil_details", "transformer_details", "shield_details", "finger_details",
        "copper_flaps_details", "resonator_details", "chip_resistor_details", "ltcc_details"
    ]
        ...
        responses={200: openapi.Response(
            ...
            schema=openapi.Schema(
                ...
                properties={
                    ...
                    "special_requirements": openapi.Schema(type=openapi.TYPE_OBJECT),
                }
            )
        )}
    )
