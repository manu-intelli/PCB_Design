...
class PiBaseRecordPartialUpdateView(generics.RetrieveUpdateAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        transformed = {
            ...
            "caseStyleType": data.get("package_details", {}).get("caseStyleType"),
            "caseStyle": data.get("package_details", {}).get("CaseStyle"),
            "interfaces": data.get("package_details", {}).get("interfaces"),
            "caseDimensions": data.get("package_details", {}).get("caseDimensions"),
