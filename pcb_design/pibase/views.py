...
class PiBaseRecordPartialUpdateView(generics.RetrieveUpdateAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        transformed = {
            ...
            "chipCapacitors": data.get("capacitor_details", {}),
            "chipInductors": data.get("inductor_details", {}),
            "chipAirCoils": data.get("aircoil_details", {}),
            "chipResistors": data.get("resistor_details", {}),
