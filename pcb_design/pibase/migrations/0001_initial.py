# Generated by Django 5.0.10 on 2025-06-09 04:48

import django.db.models.deletion
import pibase.models
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('components', models.ManyToManyField(blank=True, related_name='pi_base_records_selected_components', to='pibase.pibasecomponent', verbose_name='Components')),
                ...
                ('design_rule_violation', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='device_design_rule_violation', to='pibase.pibasefieldoption', verbose_name='Design Rule Violation')),
                ...
                ('via_holes_requirement', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='device_via_holes_requirement', to='pibase.pibasefieldoption', verbose_name='Via Holes Requirement')),
                ('status', models.ForeignKey(blank=True, default=pibase.models.get_default_status, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pi_base_records_status', to='pibase.pibasestatus', verbose_name='Status')),
            ],
            options={
