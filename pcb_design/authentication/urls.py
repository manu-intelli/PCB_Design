...
from .views import LoginView, LogoutView, UserRegistrationView,ForgetPasswordView,UserAPIView,UserListAPIView,RoleListView
...
urlpatterns = [
    ...
    path('users/', UserListAPIView.as_view(), name='get-users'),
